...
unsigned int nModifierInterval = 10 * 60; // DogeJunior - time to elapse before new modifier is computed
...
const string strMessageMagic = "DogeJunior Signed Message:\n";
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // Dogejunior: check proof-of-stake block signature
...
// Dogejunior: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DogeJunior", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "DogeJunior 22.09.2016!";
        CTransaction txNew;
        txNew.nTime = 1474549444;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1474549444;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2004131;
		if (fTestNet)
		{
			block.nNonce = 65732;
		}
        ...
        assert(block.hashMerkleRoot == uint256("0xe5f1f5697f2b846a37ad320a0852ec0c2c2950ea61bed5e544b34628f1744bdc"));
