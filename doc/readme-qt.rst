DogeJunior-qt: Qt5 GUI for DogeJunior
===============================
...
A warning for people using the *static binary* version of DogeJunior on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of DogeJunior is linked against libdb 5.0 (see also `this Debian issue`_).
